...
"""
This file, auto_eval.py, incorporates code from the L-Eval project (https://github.com/OpenLMLab/LEval):
...
The original work is attributed to its authors and the Free Software Foundation, Inc.
"""
...
def f1_score(prediction, ground_truth):
    prediction_tokens = f1_normalize_answer(prediction).split()
    ground_truth_tokens = f1_normalize_answer(ground_truth).split()
